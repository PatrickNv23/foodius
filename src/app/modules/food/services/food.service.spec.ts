...
describe('FoodService', () => {
  ...
  it('getRandomFood should return one', (done) => {
    ...
    foodService.getRandomFood().subscribe((randomFood: Food) => {
      ...
      expect([randomFood].length).toBe(1);
      done();
  ...
  it('getRandomFood should return a Food object', (done) => {
    ...
    foodService.getRandomFood().subscribe((randomFood: Food) => {
      ...
      expect(randomFood).toBeInstanceOf(Food)
      expect(randomFood.id).toBeTruthy()
      expect(randomFood.id).not.toBeNull()
      expect(randomFood.title).toBeTruthy()
      expect(randomFood.title).not.toBeNull()
      done()
